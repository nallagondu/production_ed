...
**Note**: Replace `YOUR_USERNAME` with your actual GitHub username. If the OIDC provider already exists from a previous project, make sure to import it first using the terraform import command shown above.
